    ...
    <b-navbar toggleable="md" variant="dark" type="dark">
      ...
      <b-collapse is-nav id="nav_collapse">
        <b-navbar-nav>
          ...
          <b-nav-item to="/userlist"><i class="fa fa-star" style="padding: 5px"> ScoreBoard</i></b-nav-item>
          <b-nav-item v-show="usersignedin.status" to="/Course"><i class="fa fa-file" style="padding: 5px"> Course </i></b-nav-item>
        </b-navbar-nav>
        <b-navbar-nav class="ml-auto">
          <b-nav-item to="/myaccount"><i class="fa fa-user" style="padding: 5px"> My Account </i></b-nav-item>
          <b-nav-item v-show="!usersignedin.status" to="/Login"><i class="fa fa-sign-in" style="padding: 5px"> Login </i></b-nav-item>
